...
# ACDS 16.1 203 win32 2017.06.12.10:49:33
...
# ----------------------------------------
# If VIDEO_PLL is one of several IP cores in your
...
TOP_LEVEL_NAME="VIDEO_PLL"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="E:/intelfpga/16.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/VIDEO_PLL.vo"
fi
