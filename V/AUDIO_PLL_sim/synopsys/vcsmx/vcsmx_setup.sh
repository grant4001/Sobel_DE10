...
# ACDS 16.1 203 win32 2017.06.12.10:49:59
...
# ----------------------------------------
# If AUDIO_PLL is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/AUDIO_PLL.vo"
fi
